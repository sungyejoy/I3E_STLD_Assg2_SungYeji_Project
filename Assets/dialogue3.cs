...
public class dialogue3 : MonoBehaviour
{
    ...
    public bool dialogue3_destroy = false;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        if (other.gameObject.tag == "Player")
        {
            ...
            dialogue_text.text = "I should explore this planet I landed on. " +
                "But before I exit, let me find my gun";
        }
    }
    ...
    private void OnTriggerExit(Collider other)
    {
        ...
        if (other.gameObject.tag == "Player")
        {
            ...
            dialogue3_destroy = true;
            Debug.Log("dialogue 3 done");
            Destroy(gameObject);
        }
    }
