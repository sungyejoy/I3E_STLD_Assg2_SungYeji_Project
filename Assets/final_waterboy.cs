...
/// </summary>
public class final_waterboy : MonoBehaviour
{
    /// <summary>
    ...
    /// <summary>
    /// Boolean of crystal being dropped or not
    /// </summary>
    public bool crystal_drop = false;
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            Debug.Log("entered");
            Debug.Log(crystal_drop);
            if (crystal_drop == false)
            {
